<script lang="ts">
	import type { Reply } from '../../routes/blog/model';
...
{#each replies as reply}
	<div class="ml-4 flex flex-col gap-3 rounded-lg border border-stone-500 p-4">
		<div class="flex justify-between text-xs text-stone-700 dark:text-stone-300">
			<span>
				{formatBlogDate(reply.createdAt)}
				{reply.name ? reply.name : 'someone'} wrote:
			</span>
			<svg
